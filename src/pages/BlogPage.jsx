...
const responsiveCSS = `
  ...
  @media (max-width: 768px) {
    ...
    .blog-header { flex-direction: column !important; gap: 16px !important; }
    .category-tabs { overflow-x: auto !important; padding-bottom: 8px !important; }
      ...
      <div style={styles.page}>
        <div style={styles.container}>
          <header style={styles.header}>
            <h1 style={styles.title}>Gaming Blog</h1>
            <p style={styles.subtitle}>
              Stay updated with the latest gaming news, guides, and reviews
            </p>
            
            <div style={styles.controls} className="blog-header">
            ...
            <>
              ...
              {pagination.totalPages > 1 && (
                <div style={styles.pagination}>
                  ...
                  <button
                    style={styles.pageButton(false, currentPage === pagination.totalPages)}
                    onClick={() => handlePageChange(currentPage + 1)}
