    ...
    <>
      ...
      <form onSubmit={handleSubmit} style={styles.form}>
        ...
        <div style={styles.forgotLink}>
          <button type="button" onClick={() => setMode('forgot')} style={styles.forgotBtn}>
            Forgot password?
          </button>
        </div>
      ...
      <div style={styles.socialBtns}>
        <button style={styles.socialBtn}><Icons.Google /> Google</button>
        <button style={styles.socialBtn}><Icons.Discord /> Discord</button>
      </div>

      <p style={styles.switchMode}>
        Don't have an account?
        <button onClick={() => setMode('register')} style={styles.switchBtn}>Sign up</button>
      </p>
    </>
  );
  ...
  const renderRegister = () => (
    <>
      ...
      <p style={styles.switchMode}>
        ...
        <button onClick={() => setMode('login')} style={styles.switchBtn}>Sign in</button>
      </p>
    </>
  );
